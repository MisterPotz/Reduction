...
class ZUC2HMethodsClass() {
    data class Arguments(
        ...
        val E1: Long = 215000,//модуль упругости Юнга шестерни
        val E2: Long = 215000,//модуль упругости Юнга колеса
        val PUAS: Float = 0.3f//коэффициент Пуассона
    )
...
/**
 * [DW] - массив начальных диаметров (0 - шестерни, 1 - колеса)
 * [KHALF] - коэффициент, учитывающий распределение нагрузки между зубьями
 * [PSIBD] - коэффициент межосевого расстояния в долях диаметра шестерни
 * [G0] - коэффициент, учитывающий разность шагов зубьев колёс при расчёте на прочность
 * [WHV] - удельная окружная динамическая сила при расчёте на контактную прочность
 * [WV] - предельное значение удельной окружной динамической силы
 * [FT], [FR], [FA] - осевая, радиальная, окружная силы в зацеплении
 * [EPBET] - коэффициент осевого перекрытия
 * [ZEP] - коэффициент, учитывающий суммарную длину контактных линий
 * [WHT] - удельная расчётная окружная сила при расчёте на контактную прочность
 * [SGH] - расчётное контактное напряжение в полюсе зацепления
 * [SGHM] - контактные напряжения при действии максимальной нагрузки
 * [ST] - точность передачи
 * [SHEM] - схема закрепления
 * [DELH] - коэффициент, учитывающие вид зубчатой передачи
 */
