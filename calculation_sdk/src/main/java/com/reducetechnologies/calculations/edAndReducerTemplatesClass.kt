 ...
 * [NED] - частота вращения вала электродвигателя
 * [HRC] - массив твёрдостей колёс (0 - шестерни, 1 - колеса)
 * [uB] - передаточное отношение быстроходной ступени
 * [uT] - передаточное отношение тихоходной ступени
 * [u] - передаточное отношение редуктора
 * [uRatio] - отношение [uB] к [uT]
 * [uRED] - передаточное отношение редуктора
 * [PSB] - коэффициент ширины зубчатого венца в долях межосевого расстояния (промежуточное значение)
 * [PSIM] - коэффициент ширины зубчатого венца в долях модуля
 * [PED] - мощность электродвигателя
 */
...
/**
 * [PED] - мощность электродвигателя
 * [NED] - частота вращения электродвигателя
 * [TTED] - коэффициент допускаемой перегрузки
 * [D1ED] - диаметр электродвигателя
 * [L1ED] - длин концов валов
 * [H1ED] - высота до оси вращения
 * [MAED] - масса электродвигателя
 */
data class EDScope(
    var PED: Float? = null,
    var NED: Int? = null,
