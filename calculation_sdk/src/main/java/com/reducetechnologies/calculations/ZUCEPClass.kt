...
/**
 * [D], [DB], [DA], [DF] - массивы делительных, основных, вершин, впадин - диаметров колёс
 * [CF] - действительный зазор в зацеплении
 * [DK] - диаметры окружностей притупленных кромок зубьев колёс
 * [ALFK] - угол профиля зуба в точке притупленных кромок
 * [ROP] - радиусы кривизны активного участка в нижней точке
 * [ROL] - радиус кривизны в граничной точке профиля (в начале эвольвентного участка зуба)
 * [PSIZC] - коэффициент потерь в зацеплении
 * [DELY] - коэффициент уравнительного смещения в зацеплении
 * [EA] - составляющие коэффициента торцового перекрытия
 * [EAM] - максимальная составляющая коэффициента торцового перекрытия
 * [EPALF] - коэффициент торцового перекрытия
 * [ALFW02] - угол зацепления долбяка с колесом
 * [AW02] - межосевое расстояние в станочном зацеплении долбяка с колесом
 * [ALFA0] - угол профиля зуба долбяка на окружности вершин
 * [Z0] - число зубьев долбяка
 * [X0] - коэффициент смещения долбяка
 * [D0] - диаметр делительной окружности долбяка
 * [DA0] - диаметр окружности вершин долбяка
 * [interference] - показатель наличия интерференции зубьев
 * [isEpalfLess] - показатель непринижения коэффициента торцевого перекрытия
 */
