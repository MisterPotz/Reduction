...
/**
 * [SGF] - напряжения при расчёте на сопротивление усталости при изгибе
 * [SGFM] - изгибные напряжения при максимальных нагрузках
 * [DELF] - коэффициент, учитывающий вид зубчатой передачи
 * [WFV] - удельная окружная динамическая сила при расчёте на изгиб
